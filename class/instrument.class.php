...
class instrument extends CommonObject
{
	...
	public $fields=array(
		...
		'name' => array('type'=>'varchar(128)', 'label'=>'Name', 'enabled'=>1, 'visible'=>1, 'position'=>1, 'notnull'=>1, 'searchall'=>1,),
		'price' => array('type'=>'double(24,2)', 'label'=>'Price', 'enabled'=>1, 'visible'=>1, 'position'=>3, 'notnull'=>-1, 'isameasure'=>'1',),
	);
	public $rowid;
	public $ref;
	public $description;
