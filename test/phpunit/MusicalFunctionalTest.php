...
/**
 * \file    test/functional/MusicalFunctionalTest.php
 * \ingroup musical
 ...
 * @package Testmusical
 */
class MusicalFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/musical/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('musical/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/musical/admin/about.php');
		$this->authenticate();
		return $this->assertContains('musical/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('musicalwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMusical_MusicalTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMusical_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
