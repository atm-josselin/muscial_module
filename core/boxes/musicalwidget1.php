...
/**
 * \file    modulebuilder/template/core/boxes/musicalwidget1.php
 * \ingroup musical
 * \brief   Widget provided by Musical
 *
 ...
 */
class musicalwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "musicalbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "musical@musical";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->musical->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/musical/class/musical.class.php";

		// Populate the head at runtime
		$text = $langs->trans("MusicalBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_musical@musical',
