...
dol_include_once("/musical/class/myobject.class.php");


/**
 * mailing_mailinglist_musical
 */
class mailing_mailinglist_musical_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_musical_myobject';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('musical',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/musical/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_musical_myobject.modules.php: mailing ".$num." targets found");
