...
class pdf_azur_mention extends ModelePDFPropales
{
    ...
    var $phpmin = array(1,0,0); // Minimum version of PHP required by module
    var $version = '7.0.0 ';
    ...
    function __construct($db)
    {
        ...
        $this->description = 'Modèle de proposition commerciale incluant les mentions complémentaires';
